...
const UserFormMandatory = () => {
  ...
  const handleTabChange = async (tab, formik) => {
        ...
        <Col md={10} lg={8}>
          <Card>
            ...
            <Card.Body>
              ...
              >
                {(formik) => {
                  // Update form errors when Formik errors change - without using useEffect hook
                  // We'll use a simple assignment since we can't use hooks here
                        ...
                        <Nav variant="tabs" className="mb-4">
                          <Nav.Item>
                            <Nav.Link 
                              ...
                              onClick={(e) => {
                                e.preventDefault();
                                handleTabChange('personal', formik);
                              }}
                            >
                              <i className={`bi ${isTabComplete('personal') && !hasTabErrors('personal') ? 'bi-check-circle-fill' : 'bi-1-circle'} me-2`}></i>
                              Personal Info
                          ...
                          <Nav.Item>
                            <Nav.Link 
                              ...
                              onClick={(e) => {
                                e.preventDefault();
                                handleTabChange('address', formik);
                              }}
                            >
                              <i className={`bi ${isTabComplete('address') && !hasTabErrors('address') ? 'bi-check-circle-fill' : 'bi-2-circle'} me-2`}></i>
                              Address Info
                          ...
                          <Nav.Item>
                            <Nav.Link 
                              ...
                              onClick={(e) => {
                                e.preventDefault();
                                handleTabChange('account', formik);
                              }}
                            >
                        ...
                        <Tab.Content>
                          ...
                          <Tab.Pane eventKey="personal">
                            ...
                            <div className="d-flex justify-content-between mt-4">
                              ...
                              <Button 
                                variant="primary" 
                                onClick={() => handleTabChange('address', formik)}
                              >
                          ...
                          <Tab.Pane eventKey="address">
                            ...
                            <div className="d-flex justify-content-between mt-4">
                              <Button 
                                ...
                                onClick={() => handleTabChange('personal', formik)}
                              >
                                <i className="bi bi-arrow-left me-2"></i>Back
                              </Button>
                              <Button 
                                variant="primary" 
                                onClick={() => handleTabChange('account', formik)}
                              >
...
export default UserFormMandatory;